...
public class Solution
{
    ...
    public static long  getTimeMsOfGet(List list)
    {
        ...
        Date currentTite = new Date(); //получение текущего даты и времени
        get10000(list);

        //Напишите тут ваш код
        Date newTime = new Date();  // получение нового текущего даты и времени

        long msDelay = newTime.getTime() - currentTite.getTime();
        return  msDelay;
